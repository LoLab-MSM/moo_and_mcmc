...
earm_rates = {'bind_L_R_to_LR_kf':{'type': 'normal', 'mean': 1e4*cyto_bi_mol_rxn_scale, 'sd': 1., 'source': 'TransComp', 'PDB': ['1D4V', '1D0G', '1DU3']},
              ...
              'bind_CytoCA_ApafI_to_CytoCAApafI_kf': {'type': 'uniform', 'lower': kf_lower_cyto, 'upper': kf_upper_cyto},
              ...
              'bind_BidM_Bcl2M_kf': {'type': 'uniform', 'lower':kf_lower_mito, 'upper': kf_upper_mito},
              'bind_BidM_Bcl2M_kr': {'type': 'normal', 'mean': 100e-9*mito_kd_mol_rxn_scale, 'sd': 1., 'source': 'experimental', 'ref': ['Certo 2006', 'Ku 2011', 'Letai 2002']},
              ...
              'bind_BakA_Mcl1M_kf': {'type': 'uniform', 'lower': kf_lower_mito, 'upper': kf_upper_mito},
              'bind_BakA_Mcl1M_kr': {'type': 'normal', 'mean': 10e-9*mito_kd_mol_rxn_scale, 'sd': 2./3, 'source': 'experimental', 'ref': ['Zhai 2008', 'Ku 2011']},
