...
with model:
    ...
    step = pm.Dream(variables=[model.params], nseedchains=nseedchains, blocked=True, multitry=5, start_random=False, save_history=True, parallel=True, adapt_crossover=False, history_file='2015_04_20_earm_direct_mtdreamzs_normal_prior_history.npy', crossover_file='2015_04_18_earm_direct_mtdreamzs_normal_prior_crossovervals.npy')
    
    old_trace = text.load('2015_04_20_earm_direct_mtdreamzs_normal_prior')
    trace = pm.sample(15000, step, njobs=3, trace=old_trace) #pass njobs=None to start multiple chains on different cpus
    
    text.dump('2015_04_21_earm_direct_mtdreamzs_normal_prior', trace)    
    ...
    pickle.dump(dictionary_to_pickle, open('2015_04_21_earm_direct_mtdreamzs_normal_prior.p', 'wb'))
