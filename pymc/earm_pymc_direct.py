...
with model:
    ...
    step = pm.Dream(variables=[model.params], nseedchains=nseedchains, blocked=True, multitry=5, start_random=False, save_history=True, parallel=False, adapt_crossover=False, history_file='2015_04_28_earm_direct_mtdreamzs_normal_prior_history.npy', crossover_file='2015_04_18_earm_direct_mtdreamzs_normal_prior_crossovervals.npy')
    
    old_trace = text.load('2015_04_28_earm_direct_mtdreamzs_normal_prior')
    ...
    text.dump('2015_04_29_earm_direct_mtdreamzs_normal_prior', trace)    
    ...
    pickle.dump(dictionary_to_pickle, open('2015_04_29_earm_direct_mtdreamzs_normal_prior.p', 'wb'))
    ...
    old_traces = pickle.load(open('2015_04_28_earm_direct_mtdreamzs_normal_prior_merged_traces_65000.p'))
    trace_list = [old_traces, dictionary_to_pickle]
    merged_traces = merge_traces(trace_list)
    
    pickle.dump(merged_traces, open('2015_04_29_earm_direct_mtdreamzs_normal_prior_merged_traces_80000.p', 'wb'))
