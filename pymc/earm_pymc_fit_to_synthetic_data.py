...
exp_data = {}
exp_path = '/Users/Erin/git/moo_and_mcmc/pymc'

exp_data['norm_ICRP'] = np.load(os.path.join(exp_path, 'mBid_mean.npy'))
exp_data['nrm_var_ICRP'] = np.load(os.path.join(exp_path, 'mBid_sd.npy'))
exp_data['norm_ECRP'] = np.load(os.path.join(exp_path, 'cPARP_mean.npy'))
exp_data['nrm_var_ECRP'] = np.load(os.path.join(exp_path, 'cPARP_sd.npy'))
...
momp_data = np.load(os.path.join(exp_path, 'momp_mean.npy'))
momp_var = np.load(os.path.join(exp_path, 'momp_sd.npy'))
